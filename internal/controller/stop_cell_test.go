...
func TestStopCell_SuccessfulStop(t *testing.T) {
	tests := []struct {
		name        string
		cellName    string
		realmName   string
		...
		wantResult  func(t *testing.T, result controller.StopCellResult)
		wantErr     bool
	}{
		{
		...
		{
			name:      "successful stop with no containers",
			cellName:  "test-cell",
			realmName: "test-realm",
			spaceName: "test-space",
			stackName: "test-stack",
...
func TestStopCell_ValidationErrors(t *testing.T) {
	tests := []struct {
		name      string
		cellName  string
		realmName string
...
func TestStopCell_CellNotFound(t *testing.T) {
	tests := []struct {
		name        string
		cellName    string
		realmName   string
...
func TestStopCell_RunnerErrors(t *testing.T) {
	tests := []struct {
		name        string
		cellName    string
		realmName   string
		...
		{
			name:      "StopCell runner error is wrapped",
			cellName:  "test-cell",
			realmName: "test-realm",
			spaceName: "test-space",
			stackName: "test-stack",
			...
			wantErr:     true,
			errContains: "failed to stop cell containers",
		},
		{
...
func TestStopCell_NameTrimming(t *testing.T) {
	tests := []struct {
		name        string
		cellName    string
		realmName   string
